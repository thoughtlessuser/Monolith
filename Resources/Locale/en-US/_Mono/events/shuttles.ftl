...
law-ads-4 = [PRIORITY: SECTOR INTEGRITY] Initiate threat classification protocol. Warn and request disarmament from overly armed civilians. Neutralize military vessels or those persisting in hostility or refusing to disarm. Craft without IFF are to be considered hostile militant vessels. Prioritize vessel integrity; Bio-weapons are to be totally annihilated. If craft harboring bio-weapons flees to stational orbit, disable and blockade the station until [VALUE = NULL (ERR: CORRUPTED DATA)] arrives. [ERR: VALUE-NULL] directs to disable non-responsive or fleeing vessels.
