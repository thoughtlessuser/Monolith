...
contraband-examine-text-Class3Pirate = [color=crimson]This ASR insurgent item is considered class 3 contraband, and its possession is illegal.[/color]
contraband-examine-text-Class3PirateHighValue = [color=crimson] This ASR insurgent item is considered highly valuable class 3 contraband, and its possession is illegal.[/color]
